...
tmp="${env_file}.tmp"
grep -v -E '^export (VOICE_PLAYBACK_PATH|VOICE_SPK_VOLUME|VOICE_CHANNEL|VOICE_GAIN_DB|VOICE_SECONDS|VOICE_WAKE_SECONDS|VOICE_COMMAND_SECONDS|VOICE_SESSION_SECONDS|VOICE_LOOP_PAUSE_SECONDS|VOICE_WAKE_WORDS|WAKE_ACK_TEXT|SKIP_WELCOME)=' "$env_file" > "$tmp"
cat >> "$tmp" <<'EOF'
...
grep -E '^export (VOICE_PLAYBACK_PATH|VOICE_SPK_VOLUME|VOICE_CHANNEL|VOICE_GAIN_DB|VOICE_SECONDS|VOICE_WAKE_SECONDS|VOICE_COMMAND_SECONDS|VOICE_SESSION_SECONDS|VOICE_LOOP_PAUSE_SECONDS|VOICE_WAKE_WORDS|WAKE_ACK_TEXT|SKIP_WELCOME)=' "$env_file"
