...
tmp="${env_file}.tmp"
grep -v -E '^export (VOICE_PLAYBACK_PATH|VOICE_SPK_VOLUME|VOICE_CHANNEL|VOICE_GAIN_DB|VOICE_SECONDS|VOICE_WAKE_SECONDS|VOICE_COMMAND_SECONDS|VOICE_SESSION_SECONDS|VOICE_TTS_ASYNC|VOICE_RETAIL_TTS|WAKE_ACK_TEXT|SKIP_WELCOME)=' "$env_file" > "$tmp"
cat >> "$tmp" <<'EOF'
...
grep -E '^export (VOICE_PLAYBACK_PATH|VOICE_SPK_VOLUME|VOICE_CHANNEL|VOICE_GAIN_DB|VOICE_SECONDS|VOICE_WAKE_SECONDS|VOICE_COMMAND_SECONDS|VOICE_SESSION_SECONDS|VOICE_TTS_ASYNC|VOICE_RETAIL_TTS|WAKE_ACK_TEXT|SKIP_WELCOME)=' "$env_file"
